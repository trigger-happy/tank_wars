...
#define TANK_STATE_INACTIVE			0
#define TANK_STATE_NEUTRAL			1
#define TANK_STATE_MOVING_FORWARD	2
#define TANK_STATE_MOVING_BACKWARD	3
#define TANK_STATE_FIRING			4
#define TANK_STATE_RELOADING		5
